...
export const cfaSignIn = (
  providerId: string,
  data?: SignInOptions
): Observable<{userCredential: firebase.auth.UserCredential; result: SignInResult}> => {
...
export const cfaSignInGoogle = (): Observable<{
  ...
  return new Observable((observer) => {
    ...
    // native sign in
    CapacitorFirebaseAuth.signIn<GoogleSignInResult>({providerId})
...
export const cfaSignInFacebook = (): Observable<{
  ...
  return new Observable((observer) => {
    ...
    // native sign in
    CapacitorFirebaseAuth.signIn<FacebookSignInResult>({providerId})
...
export const cfaSignInTwitter = (): Observable<{
  ...
  return new Observable((observer) => {
    ...
    // native sign in
    CapacitorFirebaseAuth.signIn<TwitterSignInResult>({providerId})
...
export const cfaSignInApple = (): Observable<{
  ...
  return new Observable((observer) => {
    // native sign in
    CapacitorFirebaseAuth.signIn<AppleSignInResult>({providerId: cfaSignInAppleProvider})
...
): Observable<{userCredential: firebase.auth.UserCredential; result: PhoneSignInResult}> => {
  return new Observable((observer) => {
    // get the provider id
    const providerId = firebase.auth.PhoneAuthProvider.PROVIDER_ID;

    CapacitorFirebaseAuth.signIn<PhoneSignInResult>({providerId, data: {phone, verificationCode}})
